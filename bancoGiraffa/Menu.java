...
//codigo para fornecer dicas para o TF (menu)
...
{//atributos da classe Menu, os nomes dos atributos sao auto explicativos
    ...
    {// construtor
        ...
        Locale.setDefault(Locale.US);// utilizarei a biblioteca Locale para nao ter problemas de "," "." na hora de separar a case decimal dos numeros reais
        //sem isto pode gerar um erro na utilizacao de "," ou "." dependendo da versao do compilador java)
